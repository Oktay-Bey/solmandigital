// Batch 25 — İstanbul sağlık & estetik klinikleri 2. parti (TR)
// AI otomasyon odaklı, fiyat-mailde şablon (batch 24 ile aynı).
// Kaynak: scripts/saglik-batch25-raw.json (Apify email-scraper → temizlenmiş, sent filtreli)
// Kullanım: node scripts/build-mails-batch-25.mjs
...
const TITLE_FIX = {
  "Estetik Diş Hekimi": "Kliniğiniz",
  "Saç ekimi Türkiye": "Kliniğiniz",
  "V estetik diş": "Kliniğiniz",
  "Dr. Engin Öcal": "Kliniğiniz",
  "Reşitpaşa Diş": "Kliniğiniz",
  "Prof. Dr. Mustafa TEK": "Kliniğiniz",
}

const found = rd("./saglik-batch25-raw.json")
...
writeFileSync(
  new URL("./leads-batch-25.json", import.meta.url),
  JSON.stringify(out, null, 2),
  "utf8"
)
console.log(`${out.length} mail üretildi → scripts/leads-batch-25.json`)
