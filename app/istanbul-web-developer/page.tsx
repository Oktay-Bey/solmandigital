          ...
          <Reveal>
            ...
            <div className="flex flex-wrap gap-2.5">
              {[
                ...
                { href: "/sisli-web-tasarim", label: "Şişli Web Tasarım" },
                { href: "/besiktas-yazilim-gelistirme", label: "Beşiktaş Yazılım Geliştirme" },
                { href: "/besiktas-web-tasarim", label: "Beşiktaş Web Tasarım" },
                { href: "/besiktas-yapay-zeka-otomasyon", label: "Beşiktaş AI & Yapay Zeka Otomasyon" },
